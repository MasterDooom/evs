  ...
  return '<article class="document">'+
    ...
    '<div class="document-grid">'+
      '<main class="document-body">'+
        ...
        '<section class="doc-section visual-section"><div class="section-label"><span>03</span> VISUAL MODEL</div><p class="section-hint">Use the sequence below to recall the structure without rereading the paragraph.</p>'+flow(t)+table(t)+technicalPanel(t)'</section>'+
